...
class HandHourPainter extends CustomPainter {
  final bool showHeartShape;
  final Paint hourHandPaint;
  int hours;
  int minutes;

  HandHourPainter({this.hours, this.minutes, this.showHeartShape = false})
      : hourHandPaint = Paint() {
    hourHandPaint.color = Colors.redAccent;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawShadow(path, Colors.black, 0.0, false);

    canvas.restore();
  }

  @override
  bool shouldRepaint(HandHourPainter oldDelegate) {
    return true;
  }
}
